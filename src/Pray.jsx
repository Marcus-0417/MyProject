        ...
        <>
            <div id="section-4" className="section" ref={ref}>
                <div className="Pray-wrapper">
                    ...
                    <h2>壹·誠心祈禱</h2>
                    <p data-aos="flip-right" data-aos-duration="1500">雙手合十向神明表達祈願，心中默念自己的姓名、出生年月日（或生辰八字）、地址等。<br /><br />說明問題：清楚地將問題陳述一次，可以是關於健康、事業、感情、家庭等方面，並盡量將問題具體化。</p>
                </div>
                ...
                <div className="Pray-wrapper">
                    ...
                    <h2>三·擲筊請示</h2>
                    <p data-aos="flip-right" data-aos-duration="1500">接著擲筊確認籤意<br /><br />連續3個聖筊：恭喜!神明指示這支籤是要給你的。<br />
                        陰筊或笑筊：籤不準，需重新抽籤。</p>
                </div>
